...
public class CadisTaxonomyTopicListStrategyTest {
    ...
    public void verifyReturnResults() {
        ...
        when(mockTopicRepository.findByTaxonomy(Taxonomy.CADIS_DISCIPLINE)).thenReturn(expectedTopics);

        CadisTaxonomyTopicListStrategy strategy = new CadisTaxonomyTopicListStrategy(mockTopicRepository);
