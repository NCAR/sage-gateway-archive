...
public class GridftpEndpointStrategyTest {
    ...
    public void testEndpointExists() {
        ...
        when(mockFileAccessPoint.getEndpoint()).thenReturn(URI.create("gsiftp://localhost:8080/"));
        ...
        GridftpEndpointStrategy strategy = new GridftpEndpointStrategy();
    ...
    public void testGetEndpointFromExternalSource() {
        ...
        assertThat(endpoint, equalTo(URI.create("gsiftp://localhost.com/file.txt?size=12345")));
    }
