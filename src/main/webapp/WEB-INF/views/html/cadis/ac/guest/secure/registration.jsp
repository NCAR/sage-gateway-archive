<%--
    ...
    WEB-INF/views/html/ac/guest/secure/registration.jsp
--%>
...
<tiles:insertDefinition name="general-layout">
    ...
    <tiles:putAttribute name="body">
        ...
        <p>
            During the account creation process you will be contacted through e-mail <br/>to determine what
            projects and/or data sets you will be editing.
        </p>
