...
<tiles:insertDefinition name="general-layout">
    ...
    <tiles:putAttribute type="string" name="title" value="Add DOI (Digital Object Identifier)"/>
    <tiles:putAttribute type="string" name="pageTitle" value="Add DOI (Digital Object Identifier)"/>
    ...
    <tiles:putAttribute name="body">
        ...
        <c:url var="formAction" value="/dataset/${dataset.shortName}/doi.html"/>
        <springForm:form method="post" commandName="command" action="${formAction}">
            ...
            <button type="submit" class="btn btn-default" id="addButton">Add DOI</button>
        </springForm:form>
