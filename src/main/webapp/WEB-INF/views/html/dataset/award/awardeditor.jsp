...
<tiles:insertDefinition name="general-layout">
    ...
    <tiles:putAttribute type="string" name="title" value="Dataset Award Editor"/>
    <tiles:putAttribute type="string" name="pageTitle" value="Dataset Award Editor"/>
    ...
    <tiles:putAttribute name="body">
        ...
        <springForm:form method="post" commandName="command">
            <browse:descriptive-row fieldName="Dataset" fieldValue="${command.dataset.title}" showEmpty="false"/>
