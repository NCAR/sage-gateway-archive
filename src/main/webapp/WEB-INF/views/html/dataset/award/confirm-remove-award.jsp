        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <c:url var="removeAward"
                       value="/dataset/${dataset.shortName}/awardNumber/${gateway:urlEncode(awardNumber)}.html"/>
                ...
                <c:url var="cancelRemoveAward" value="/dataset/${dataset.shortName}/awardNumber.html"/>
