        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <c:url var="deleteResponsibleParty"
                       value="/project/${dataset.shortName}/responsibleParty/${responsibleParty.identifier}.html"/>
                ...
                <c:url var="cancelDeleteResponsibleParty" value="/project/${dataset.shortName}/responsibleParty.html"/>
