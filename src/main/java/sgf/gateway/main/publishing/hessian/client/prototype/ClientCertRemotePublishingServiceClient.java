package sgf.gateway.main.publishing.hessian.client.prototype;
...
public class ClientCertRemotePublishingServiceClient extends RemotePublishingServiceClient {
    ...
    public static void main(String... s) throws Exception {
        ...
        ApplicationContext ctxt = new ClassPathXmlApplicationContext("classpath:sgf/gateway/main/publishing/hessian/client/prototype/client-prototype-esg.xml");
