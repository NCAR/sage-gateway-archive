...
public class EmailPasswordControllerStrategyForOpenid implements EmailPasswordControllerStrategy {
    ...
    public EmailPasswordControllerStrategyForOpenid(AccountService accountService, UserRepository userRepository, MailService mailService, Validator validator) {
    ...
    public ModelAndView showForm() {
        ...
        return new ModelAndView("/ac/guest/secure/emailPasswordForOpenidAndEmailRequest");
    }
    ...
    public ModelAndView handleSubmit(User user, BindingResult bindingResult) {
        ...
        if (bindingResult.hasErrors()) {
            ...
            try {
                ...
                user = this.userRepository.findUserByOpenid(user.getOpenid());
