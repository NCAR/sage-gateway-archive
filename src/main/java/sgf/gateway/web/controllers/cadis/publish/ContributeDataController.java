...
public class ContributeDataController {
    ...
    private static final String CREATE_VIEW = "cadis/publish/contributeData";  //Projects

    public ContributeDataController(final MetadataService metadataService, final RuntimeUserService runtimeUserService) {
        this.metadataService = metadataService;
        this.runtimeUserService = runtimeUserService;
    }

    @RequestMapping(value = "/user/publish/contributeData", method = RequestMethod.GET)
