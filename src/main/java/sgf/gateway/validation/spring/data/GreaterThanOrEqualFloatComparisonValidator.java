...
public class GreaterThanOrEqualFloatComparisonValidator implements Validator {
    ...
    public GreaterThanOrEqualFloatComparisonValidator(final String floatField1, final String floatField2, final String errorCode, final String defaultMessage) {
