...
@Constraint(validatedBy = AssertUniqueTitleValidator.class)
// "Specifies the validator to be used to validate (this annotation type)..."
@Documented
public @interface AssertUniqueTitle {
    ...
    String message() default "{sgf.gateway.validation.persistence.asserttitleunique}";
