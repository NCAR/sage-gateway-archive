...
public class DatasetVersionStateRetractedImpl implements DatasetVersionState {

    private final PublishedState publishedState;

    private final DatasetVersionImpl datasetVersionImpl;

    public DatasetVersionStateRetractedImpl(DatasetVersionImpl datasetVersionImpl) {

        this.publishedState = PublishedState.RETRACTED;
    ...
    public void changeState(PublishedState newPublishedState) {
        ...
        if (PublishedState.PRE_PUBLISHED == newPublishedState) {
            ...
            throw new IllegalStateException("Transitioning from RETRACTED state to PRE-PUBLISHED state is not allowed");
    ...
    public void addLogicalFile(LogicalFile logicalFile) {
        ...
        throw new IllegalStateException("Adding LogicalFiles to a DatasetVersion in RETRACTED state is not allowed");
    }

    public void removeLogicalFile(LogicalFile logicalFile) {

        throw new IllegalStateException("Removing LogicalFiles from a DatasetVersion in RETRACTED state is not allowed");
    }

    public void addVariable(Variable variable) {

        throw new IllegalStateException("Adding Variables to a DatasetVersion in RETRACTED state is not allowed");
    }

    public void removeVariable(Variable variable) {

        throw new IllegalStateException("Removing Variables from a DatasetVersion in RETRACTED state is not allowed");
    }
}
